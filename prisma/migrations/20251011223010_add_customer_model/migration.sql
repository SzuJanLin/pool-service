-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'OWNER', 'TECH');

-- CreateEnum
CREATE TYPE "CustomerStatus" AS ENUM ('LEAD', 'ACTIVE', 'INACTIVE', 'LOST');
...
CREATE TABLE "Company" (
    ...
    "slug" TEXT NOT NULL,
    "domain" TEXT,
    "defaultRole" "Role" NOT NULL DEFAULT 'TECH',
    "billingId" TEXT,
...
-- CreateIndex
CREATE INDEX "Company_billingId_idx" ON "Company"("billingId");
