...
const CompanySSO = ({ companyFeatures, SPConfigURL }) => {
  ...
  return (
    <>
      <CompanyTab activeTab="sso" company={company} companyFeatures={companyFeatures} />
      <ConnectionsWrapper
        urls={{
          spMetadata: SPConfigURL,
          get: `/api/companies/${company.slug}/sso`,
          post: `/api/companies/${company.slug}/sso`,
          patch: `/api/companies/${company.slug}/sso`,
          delete: `/api/companies/${company.slug}/sso`,
        }}
        successCallback={({
          operation,
          connectionIsSAML,
